...
\begin{frame}
  ...
  \begin{presentation_definition}
    A \emph{linear transformation} is a transformation $\func{T}{A}{B}$, that obeys the following two criteria:
    \begin{enumerate}
        \onslide<2->{
...
\begin{frame}
  ...
  % Scale in y-axis
        \only<2>{
          \pgftransformcm{1}{0}{0}{0.5}{\pgfpoint{0cm}{0cm}}
          \drawaxes{-5}{-5}{5}{5}[0.5][black!50][-][white]
          \draw[vector, col1] (0,0) -- (2.5,0);
          \draw[vector, col2] (0,0) -- (0,2.5);
          \draw[col1, thick, fill=col1!50, fill opacity=0.5] (3,2) -- (4,4) -- (2,3) -- cycle;
  ...
  % Scale in y-axis
        \only<3>{
          \pgftransformcm{0.71}{-0.71}{0.25}{0.25}{\pgfpoint{0cm}{0cm}}
          \drawaxes{-5}{-5}{5}{5}[0.5][black!50][-][white]
          \draw[vector, col1] (0,0) -- (2.5,0);
          \draw[vector, col2] (0,0) -- (0,2.5);
          \draw[col1, thick, fill=col1!50, fill opacity=0.5] (3,2) -- (4,4) -- (2,3) -- cycle;
