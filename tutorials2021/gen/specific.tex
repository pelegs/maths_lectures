...
\pagestyle{fancy}
\lhead{Computer Science and Mathematics (B.MES.108), SoSe21}

\title{Computer Science and Mathematics (B.MES.108)\\Tutorial, Summer Semester 2021\\}
\author{Peleg Bar Sapir}
 
\def\exnum{\ex}
\setcounter{secnumdepth}{2}
\renewcommand{\thesection}{Exercise \ex:}
\renewcommand{\thesubsection}{Problem \arabic{subsection}:}
\titleformat{\section}[display]{\normalfont\bfseries\Large}{Exercise \ex: #1\solutionhead}{-20pt}{}

\begin{document}
\rhead{Exercise \ex\solutionhead}
\include{source/ex\ex}
\newpage
\end{document}
